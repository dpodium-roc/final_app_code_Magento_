<?php
namespace Magento\Pipwave\Block\Adminhtml\Order\View;

/*
this class wil be used by
Magento\Pipwave\Controller\Notification\Index
Magento\Pipwave\view\adminhtml\template\order\view\info.phtml
*/
class Info extends \Magento\Framework\View\Element\Template
{
    ...
    //called in Magento\Pipwave\view\adminhtml\template\order\view\info.phtml
    function getOrder() {
        if ($this->hasOrder()) {
