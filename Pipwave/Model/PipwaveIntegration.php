...
class PipwaveIntegration {
    ...
    //render is in Magento\Pipwave\view\frontend\web\js\view\payment\method-renderer\custompayment.js
    protected $result;
    ...
    //NOT called in Magento\Pipwave\Block\InformationNeeded.php
    function getResult(){
        return $this->result;
    }
}